...
Score: 8 marks: 2 each for items 1 to 3 (answer, reason), 1 each for items 4 and 5. A mark earned only after a hint counts half. Record Retry = marks / 8. 0 for a part that keeps a calculator, a store or a failed lookup.
...
Score: 8 marks: 2 each for items 1 to 3 (answer, reason), 1 each for items 4 and 5. A mark earned only after a hint counts half. Record Cold = marks / 8. 0 for a part that keeps a calculator, a store or a failed lookup.

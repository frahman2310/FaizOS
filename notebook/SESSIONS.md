...
## 2026-08-13 — 5 ships
**Shipped:** Post-training: distillation vs RL, DPO, and tool calling · Agents &amp; retrieval: RAG, memory, agentic RL, evals · Multimodal: ViT/CLIP, diffusion &amp; flow matching, VLM fusion · Safety &amp; interpretability: oversight, SAEs, prompt injection · Foundations sweep: SVD, probability, geometry, regression, complexity, init
**Learned:** Reward modeling — preferences, proxies and reward hacking · Foundations sweep — SVD, probability, geometry, regression, complexity, init
...
**Coverage:** 95% · 19/20 modules complete · 43 total ships
<!-- /session 2026-08-13T12:14:37.952Z -->
